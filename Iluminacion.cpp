...
int main()
{
    ...
    // Load models
    Model Bocina((char*)"Practica_8_modelo/Bocinas.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc, lightPos.x + movelightPos + movelightPosX, lightPos.y + movelightPos + movelightPosY, lightPos.z + movelightPos + movelightPosZ);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos + movelightPos + glm::vec3(movelightPosX, movelightPosY, movelightPosZ));
